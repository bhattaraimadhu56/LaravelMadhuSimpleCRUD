...
<link href="{{('css/bootstrap-responsive.min.cs')}}s" rel="stylesheet">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="messages.html"><i class="icon-envelope"></i><span class="hidden-tablet">All Contact</span></a></li>
